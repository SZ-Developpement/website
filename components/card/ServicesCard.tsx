...
export default function ServicesCard({
  ...
  return (
    <div className="bg-[#0a0a0b] border border-transparent hover:border-[rgba(255,255,255,0.16)] rounded-2xl transition-all duration-150 hover:bg-[#0d0d0e] p-5 overflow-hidden flex flex-col group">
      {/* icon */}
