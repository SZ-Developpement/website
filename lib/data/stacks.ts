const routes_fontend = "/stack/frontend/";
const routes_backend = "/stack/backend/";
const routes_database = "/stack/database/";
const routes_devops = "/stack/devops/";
const routes_mobile = "/stack/mobile/";
const routes_tools = "/stack/tools/";
const routes_languages = "/stack/languages/";

export const stack = [
  {
    name: "Next.js",
    icon: `${routes_fontend}nextjs.svg`,
    category: "Frontend",
  },
  { name: "React", icon: `${routes_fontend}react.svg`, category: "Frontend" },
  {
    name: "Tailwind CSS",
    icon: `${routes_fontend}tailwindcss.svg`,
    category: "Frontend",
  },
  {
    name: "Framer Motion",
    icon: `${routes_fontend}framer-motion.svg`,
    category: "Frontend",
  },
  ...
  {
    name: "GraphQL",
    icon: `${routes_backend}graphql.svg`,
    category: "Backend",
  },
  ...
  {
    name: "PostgreSQL",
    icon: `${routes_database}postgresql.svg`,
    category: "Base de données",
  },
  {
    name: "MongoDB",
    icon: `${routes_database}mongodb.svg`,
    category: "Base de données",
  },
  {
    name: "NeonDB",
    icon: `${routes_database}neon.svg`,
    category: "Base de données",
  },
  {
    name: "Supabase",
    icon: `${routes_database}supabase.svg`,
    category: "Base de données",
  },
  {
    name: "PlanetScale",
    icon: `${routes_database}planetscale.svg`,
    category: "Base de données",
  },
  {
    name: "Redis",
    icon: `${routes_database}redis.svg`,
    category: "Base de données",
  },
  {
    name: "SQLite",
    icon: `${routes_database}sqlite.svg`,
    category: "Base de données",
  },
  {
    name: "MySQL",
  ...
  {
    name: "Docker",
    icon: `${routes_devops}docker.svg`,
    category: "DevOps & Cloud",
  },
  { name: "AWS", icon: `${routes_devops}aws.svg`, category: "DevOps & Cloud" },
  {
    name: "Vercel",
    icon: `${routes_devops}vercel.svg`,
    category: "DevOps & Cloud",
  },
  {
    name: "GitHub Actions",
    icon: `${routes_devops}github-actions.svg`,
    category: "DevOps & Cloud",
  },
  {
    name: "Terraform",
    icon: `${routes_devops}terraform.svg`,
    category: "DevOps & Cloud",
  },

  {
    name: "React Native",
    icon: `${routes_mobile}react-native.svg`,
    category: "Mobile",
  },
