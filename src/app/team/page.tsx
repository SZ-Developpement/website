      ...
      >
        <div className="flex flex-col gap-5 w-full">
          ...
          <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-extrabold leading-none">
            La prochaine <span className="gradient-text-blue">génération.</span>
          </h2>
          <p className="font-normal text-text-secondary font-body max-w-150">
            Quatre étudiants en développement, une ambition commune : livrer des
            produits dont on est fiers, avec les standards de l&apos;industrie.
          </p>
        </div>
