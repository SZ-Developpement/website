    ...
    >
      <div className="flex flex-col items-center justify-center gap-5">
        ...
        <h2 className="font-display text-4xl md:text-5xl font-extrabold leading-none text-center">
          Ce que nous avons <span className="gradient-text">construit.</span>
        </h2>

        <Link
          href="/projects"
          className="inline-flex items-center gap-2 font-normal text-text-secondary font-body max-w-150 text-center hover:text-text-primary transition-colors duration-300"
        >
